...
env = environ.Env(
    ...
    SIMPLEUI_INDEX=(str, ''),
    SIMPLEUI_LOGO=(str, ''),
    SIMPLEUI_ANALYSIS=(bool, False),
    SIMPLEUI_DEFAULT_THEME=(str, 'e-blue.css'),
    AUTO_LOGOUT_IDLE_TIME=(int, 60),
)
...
SIMPLEUI_HOME_INFO = env('SIMPLEUI_HOME_INFO')
SIMPLEUI_INDEX = env('SIMPLEUI_INDEX')
SIMPLEUI_LOGO = env('SIMPLEUI_LOGO')
SIMPLEUI_ANALYSIS = env('SIMPLEUI_ANALYSIS')
SIMPLEUI_DEFAULT_THEME = env('SIMPLEUI_DEFAULT_THEME')
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Moved up for deployment
...
if env('DATABASE_URL'):
    ...
    # Option 2: Individual database settings (fallback for MySQL)
    DATABASES = {
        'default': {
...
STATICFILES_DIRS = []
static_dir = os.path.join(BASE_DIR, 'CRS', 'static')
...
AUTO_LOGOUT = {
    'IDLE_TIME': timedelta(minutes=env('AUTO_LOGOUT_IDLE_TIME')),
